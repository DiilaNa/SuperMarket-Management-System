...
public class ItemController {
    ...
    public ItemDto searchItem(String itemCode) throws SQLException, ClassNotFoundException{
     ...
     public String updateItem(ItemDto itemDto) throws SQLException, ClassNotFoundException{
         String resp = ITEM_MODEL.updateItem(itemDto );
        return resp;
    }
    public String deleteItem(ItemDto itemDto) throws SQLException, ClassNotFoundException{
         String resp = ITEM_MODEL.deleteItem(itemDto );
        return resp;
    } 
}